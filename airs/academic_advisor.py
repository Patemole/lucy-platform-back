...
rag_keywords_chain = LLMChain(prompt=rag_keywords_prompt, llm=GROQ_LLM, output_parser=JsonOutputParser())
...
draft_answer_chain = LLMChain(prompt=draft_answer_prompt, llm=GROQ_LLM, output_parser=StrOutputParser())
